...
for k, year in enumerate(yearList[:-1]):
    ...
    tech = "SMR"
    max_install_capacity = [360,1000,0,0]
    min_install_capacity=[360,0,0,0]
    max_cumul_capacity= [360,1000,0,0]
    min_cumul_capacity =[360,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year+yearStep/2)
    scenarioWoSMR2040['conversionTechs'].append(
        pd.DataFrame(data={tech:
...
for k, year in enumerate(yearList[:-1]):
    ...
    tech = "SMR"
    max_install_capacity = [360,1000,1000,0]
    min_install_capacity=[360,0,0,0]
    max_cumul_capacity= [360,1000,1000,0]
    min_cumul_capacity =[360,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year+yearStep/2)
    scenarioWoSMR2050['conversionTechs'].append(
        pd.DataFrame(data={tech:
    ...
    tech = "SMR + CCS1"
    max_cumul_capacity= [0,1000,1000,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year+yearStep/2)
    scenarioWoSMR2050['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
...
for k, year in enumerate(yearList[:-1]):
    ...
    max_install_capacity = [360,1000,1000,1000]
    min_install_capacity=[360,0,0,0]
    max_cumul_capacity= [360,1000,1000,1000]
    min_cumul_capacity =[360,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year+yearStep/2)
    scenarioCO210['conversionTechs'].append(
        pd.DataFrame(data={tech:
    ...
    tech = "SMR + CCS1"
    max_cumul_capacity= [0,1000,1000,1000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year+yearStep/2)
    scenarioCO210['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
...
scenarioManosque={k: v.copy() for (k, v) in scenarioPACA.items()}


scenarioManosque['storageTechs'] = []
for k, year in enumerate(yearList[:-1]):
    tech = "Battery"
    ...
    scenarioManosque['storageTechs'].append(
        pd.DataFrame(data={tech:
...
scenarioManosque['storageTechs'] =  pd.concat(scenarioManosque['storageTechs'], axis=1)

scenarioDict['Manosque']=scenarioManosque
#endregion
...
for k, year in enumerate(yearList[:-1]):
    ...
    tech = "SMR"
    capex, opex, lifespan = [1300000,25000,30]
    scenarioFree['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Hydrogen production',
                'lifeSpan': lifespan, 'powerCost': 0.21, 'investCost': capex, 'operationCost': opex,
                'minInstallCapacity': 0,'maxInstallCapacity': 1000,
                'EmissionCO2': 0, 'Conversion': {'hydrogen':1,'gaz':-1.28},
                'minCumulCapacity': 0,'maxCumulCapacity': 1000 ,'RampConstraintPlus':0.3}
            }
         )
    )

    tech = "SMR + CCS1"
    max_cumul_capacity= [1000,1000,1000,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year+yearStep/2)
    scenarioFree['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
