...
Variables = {v : pd.read_csv(v+'.csv').drop(columns='Unnamed: 0') for v in v_list}
os.chdir('..')
os.chdir('..')
os.chdir('..')
...
#region Multi-tempo with storage single area  : Solving and loading results
