...
#anualElec={2020:492e6,2030:587.4e6,2040:652.8e6,2050:709.2e6,2060:709.2e6}
anualElec={2020:492e6,2030:562.4e6,2040:619.8e6,2050:659.2e6,2060:659.2e6}
hourlyH2={2020:[0],2030:[1825],2040:[2400],2050:[3710],2060:[3710]}
#hourlyH2={2020:[0],2030:[0],2040:[0],2050:[0],2060:[0]}
scenarioFr2060['resourceDemand'] =  pd.concat(
    (
        pd.DataFrame(data = {
              'YEAR': year,
...
scenarioFr2060['conversionTechs'] = []
for k, year in enumerate(yearList[:-1]):

    tech = "WindOffShore"
    max_install_capacity = [100000,100000,100000,100000,10000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [0,5200,20900,45000,45000]
    min_cumul_capacity = [0,5200,20900,45000,45000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
    ...
    tech = "WindOnShore"
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [8000, 33200 , 47200, 58000,58000]
    min_cumul_capacity = [8000, 33200 , 47200, 58000,58000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year) 
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech: 
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity=[4000,35100,79600,118000,118000]
    min_cumul_capacity =[4000,35100,79600,118000,118000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year) 
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity=[15000,15000,16000,17000,17000]
    min_cumul_capacity = [15000,15000,16000,17000,17000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    tech = "HydroRiver"
    max_install_capacityacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [11000,11000,12000,13000,13000]
    min_cumul_capacity = [11000,11000,12000,13000,13000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [63100,59400,43100,15500,15500]
    min_cumul_capacity = [63100,59400,43100,15500,15500]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [0,0,6600,13200,13200]
    min_cumul_capacity = [0,0,6600,13200,13200]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [6000,1000,0,0,0]
    min_cumul_capacity = [6000,1000,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [7100,6500,0,0,0]
    min_cumul_capacity = [7100,6500,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [100000,100000,100000,100000,100000]
    min_cumul_capacity = [0,0,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_install_capacity = [100000,100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [5000,5000,5000,500,500]
    min_cumul_capacity =[5000,0,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year, 'Category': 'Electricity production',
    ...
    max_cumul_capacity= [0,6500,7500,13400,20000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
    ...
    tech = "IntercoIn"
    max_install_capacity = [11000,22300,29700,39400,39400]
    min_install_capacity=[0,0,0,0,0]
    max_cumul_capacity= [11000,22300,29700,39400,39400]
    min_cumul_capacity =[0,0,0,0,0]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['conversionTechs'].append(
        pd.DataFrame(data={tech:
...
scenarioFr2060['conversionTechs'] =  pd.concat(scenarioFr2060['conversionTechs'], axis=1)

scenarioFr2060['storageTechs'] = []
for k, year in enumerate(yearList[:-1]):
    tech = "Battery"
    ...
    scenarioFr2060['storageTechs'].append(
        pd.DataFrame(data={tech: 
    ...
    tech = "saltCavernH2_G"
    max_install_capacity = [100000,100000,100000,100000,100000]
    max_install_power=[10000,10000,10000,10000,10000]
    capex, opex, lifespan = tech_eco_data.get_capex_new_tech_RTE(tech, hyp='ref', year=year)
    scenarioFr2060['storageTechs'].append(
        pd.DataFrame(data={tech:
                { 'YEAR': year,
...
scenarioFr2060['storageTechs'] =  pd.concat(scenarioFr2060['storageTechs'], axis=1)

scenarioFr2060['carbonTax'] = pd.DataFrame(data=list(np.linspace(0.0675,0.165, nYears-1))+[0.165],
    index=yearList, columns=('carbonTax',))

scenarioFr2060['carbonGoals'] = pd.DataFrame(data=np.linspace(974e6, 205e6, nYears),
    index=yearList, columns=('carbonGoals',))

scenarioFr2060['maxBiogasCap'] = pd.DataFrame(data=np.linspace(0, 310e6, nYears),
    index=yearList, columns=('maxBiogasCap',))

scenarioFr2060['gridConnection'] = pd.read_csv(inputPath+'CalendrierHTB_TIME.csv', sep=',', decimal='.', skiprows=0,
                                comment="#").set_index(["TIMESTAMP"])

scenarioFr2060['economicParameters'] = pd.DataFrame({
    'discountRate':[0.04], 
    'financeRate': [0.04]
    }
)
...
scenarioFr2060['resourceImportPrices'] = pd.concat(
    (
        pd.DataFrame(data={
            'YEAR': year, 
            'TIMESTAMP': t, 
...
scenarioFr2060['resourceImportCO2eq'] = pd.concat(
    (
        pd.DataFrame(data={
            'YEAR': year, 
            'TIMESTAMP': t, 
...
scenarioFr2060['convTechList'] = ["WindOnShore", "WindOffShore", "Solar", "CCG", "TAC","Coal_p", "OldNuke","NewNuke","IntercoIn","IntercoOut","curtailment","HydroReservoir","HydroRiver","CCG_H2","TAC_H2","electrolysis_AEL"]
ctechs = scenarioFr2060['convTechList']
...
scenarioFr2060['availability'] = availabilityFactor.loc[(slice(None), slice(None), itechs)]

scenarioFr2060["yearList"] = yearList
scenarioFr2060["transitionFactors"] =pd.DataFrame(
    {'TECHNO1':[],
    'TECHNO2':[],
