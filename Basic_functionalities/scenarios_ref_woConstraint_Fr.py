...
for k, year in enumerate(yearList[:-1]):
    ...
    max_cumul_capacity=[max_cumul_capacity[0]]+[round(i*1.1,0) for i in max_cumul_capacity[1:]]
    min_cumul_capacity = [0,5200,20900,45000]
    min_cumul_capacity = [min_cumul_capacity[0]]+[round(i * 0.9, 0) for i in min_cumul_capacity[1:]]
    ...
    tech = "TAC_H2"
    max_install_capacity = [0,0,100000,100000]
    min_install_capacity=[0,0,0,0]
    max_cumul_capacity= [0,0,10000,20000]
    ...
    max_install_capacity = [100000,100000,100000,100000]
    min_install_capacity=[0,0,0,0]
    max_cumul_capacity= [5000,5000,5000,500]
    max_cumul_capacity=[max_cumul_capacity[0]]+[round(i*1.1,0) for i in max_cumul_capacity[1:]]
